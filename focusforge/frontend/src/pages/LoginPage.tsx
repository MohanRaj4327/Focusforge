    ...
    <div className="min-h-screen bg-[#090d16] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md glass-panel p-8 rounded-2xl relative z-10 border border-slate-800 shadow-2xl">
        ...
        <div className="mt-6 flex items-center gap-3">
          ...
          <span className="text-[10px] text-slate-500 font-medium uppercase tracking-wider">Or continue with</span>
          <div className="flex-1 h-px bg-slate-800"></div>
        </div>

        <div className="mt-4 grid grid-cols-2 gap-3">
          <a
            href="https://focusforge-25tb.onrender.com/oauth2/authorization/google"
            className="flex items-center justify-center gap-2 py-2.5 bg-slate-900 border border-slate-700 hover:bg-slate-800 rounded-xl transition-colors text-xs text-white font-medium"
          >
          ...
          <a
            href="https://focusforge-25tb.onrender.com/oauth2/authorization/github"
            className="flex items-center justify-center gap-2 py-2.5 bg-slate-900 border border-slate-700 hover:bg-slate-800 rounded-xl transition-colors text-xs text-white font-medium"
          >
